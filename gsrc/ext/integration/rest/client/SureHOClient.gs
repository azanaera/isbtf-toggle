...
uses com.surepolicyrent.rest.ApiClient
uses com.surepolicyrent.rest.api.SurePolicyRentApi
...
class SureHOClient {
   ...
   */
  public function createClient() : SurePolicyRentApi {
    ...
    try {
      ...
      var api = apiClient.buildClient(SurePolicyRentApi)
  ...
  private static function getBuilder(builder : Builder, basePath : String) : Builder {
    ...
    builder.target(SurePolicyRentApi, basePath)
