...
final class CoverageAbstraction {
  ...
  protected static var _coverageTypeMap: Map<CoverageType, CoverageType> = {
      ...
      CoverageType.TC_HOPERSPROPBLANKET_TOGL_EXT ->CoverageType.TC_HOCONTENTSDEDUCTIBLE_TOGL_EXT,
      CoverageType.TC_HOPERSPROPACTIVE_TOGL_EXT ->CoverageType.TC_HOCONTENTSDEDUCTIBLE_TOGL_EXT,
      CoverageType.TC_HOPERSPROPCOLLECT_TOGL_EXT ->CoverageType.TC_HOCONTENTSDEDUCTIBLE_TOGL_EXT,
      CoverageType.TC_HOPERSPROPCREATIVEANDMAKER_TOGL_EXT ->CoverageType.TC_HOCONTENTSDEDUCTIBLE_TOGL_EXT,
      CoverageType.TC_HOPERSPROPFASHIONANDJEWELRY_TOGL_EXT ->CoverageType.TC_HOCONTENTSDEDUCTIBLE_TOGL_EXT,
      CoverageType.TC_HOPERSPROPFURNITUREANDAPPLIANCES_TOGL_EXT ->CoverageType.TC_HOCONTENTSDEDUCTIBLE_TOGL_EXT,
      CoverageType.TC_HOPERSPROPTECHNOLOGY_TOGL_EXT ->CoverageType.TC_HOCONTENTSDEDUCTIBLE_TOGL_EXT
  }
